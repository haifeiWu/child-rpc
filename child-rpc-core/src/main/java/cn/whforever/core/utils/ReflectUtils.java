...
public class ReflectUtils {
    ...
    public static Method getPropertySetterMethod(Class clazz, String property, Class propertyClazz) {
        ...
        try {
            ...
            throw new ChildRpcRuntimeException("No setter method for " + clazz.getName() + "#" + property, e);
        }
    }
    ...
    public static Method getPropertyGetterMethod(Class clazz, String property) {
        ...
        try {
            ...
            try {
                ...
                throw new ChildRpcRuntimeException("No getter method for " + clazz.getName() + "#" + property, e);
            }
        }
        return method;
    }
